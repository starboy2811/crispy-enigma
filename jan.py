...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 15 16:25:06 2018
...
files = ['jan1.xls','jan2.xls','jan3.xls']
...
for j in range(3):
    ...
    sheet1 = ['Sheet1','Sheet2','Sheet3','Sheet4','Sheet5','Sheet6','Sheet7','Sheet8','Sheet9','Sheet10']
    ...
    for m in range(10):
        variable_url = 'date='+date[m]+'-01-01&enddate='+date[m]+'-01-31&tp=24'
